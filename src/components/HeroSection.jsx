    ...
    <section className="relative flex items-center justify-center min-h-screen">
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-white">
          <p className="hero-name text-purple-800 font-bold mb-4 text-2xl">
            {LandingData.name}
          </p>

          <h1 className="hero-title text-4xl md:text-6xl xl:text-7xl font-extrabold leading-tight">
            {LandingData.titleFirst} <br />
          </h1>

          <p className="hero-description mt-6 text-gray-300 max-w-xl">
            {LandingData.shortDescription}
          </p>

          <div className="hero-buttons mt-10 flex flex-wrap items-center gap-5">
